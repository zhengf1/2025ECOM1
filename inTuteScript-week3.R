...
# OR as we introduced last two weeks
setwd("~/Dropbox/01 UoM-Teaching/2025-S1-Ecom1/Week3") # your path should be different 
...
plot(density(female_ahe), col="red",lty=1,
     xlab="AHE",main="Gender and Earnings")
lines(density(notfemale_ahe), col="blue",lty=1)
...
# = n * var(X) / n^2
# = var(X)/n
# Xbar +- critical_value* sd(X)/sqrt(n)
