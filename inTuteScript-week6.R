...
#****** Admin:
#***************************************************************************** 
#****** 1. Group assignment is due this Friday 11 April 5pm
#****** You should have completed most of it 
#****** and ready to submit.
#****** REVIEW your submission be the correct file!!!
#***************************************************************************** 
#*****************************************************************************
#****** 2. Remember to track your attendance record each week
#****** Email me immediately if you find an error
...
setwd("~/Dropbox/01 UoM-Teaching/2025-S1-Ecom1/Week6") # your path should be different 
getwd()
